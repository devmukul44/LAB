...
$date_n=date_create();
//echo date_timestamp_get($date_t)."<br>";
//echo date_timestamp_get($date_n)."<br>";			

// Differece in dates of late modified and current time 
echo "Miliseconds since updated ".(date_timestamp_get($date_n) - date_timestamp_get($date_t))."<br>";
